...
namespace SM.WebAPI.Migrations
{
    ...
    [Migration("20241111113934_Tourv2")]
    partial class Tourv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SM.Tournament.Domain.Player.PlayerFund", b =>
                {
                    b.Property<int>("PlayerFundID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PlayerFundID"));
                    ...
                    b.HasKey("PlayerFundID");

                    b.HasIndex("PlayerID");

                    b.ToTable("PlayerFund", "tournament");
                });
